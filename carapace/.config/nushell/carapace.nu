$env.PATH = ($env.PATH | split row (char esep) | where { $in != "/Users/ric19/Library/Application Support/carapace/bin" } | prepend "/Users/ric19/Library/Application Support/carapace/bin")
